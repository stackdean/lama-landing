...
const NavigationWrap =  styled.header`
  ...
  .nav__button{
    width: 170px;
    height: 60px;
    background: linear-gradient( 93deg,rgb(38 247 178) 0%,rgb(79 184 149) 52%,rgb(23 138 217) 100% );
    border-radius: 5px;
    font-size: 18px;
    ...
    li{
        ...
        .dropdown{
          li{
            ...
            a{
              ...
              padding: 5px 15px;
              &:hover{
                color: ${props => props.theme.menuHoverColor ? props.theme.menuHoverColor : '#26f7b2'} !important;
              }
              &:before{
                content: none;
              }
      ...
      a, .nav-active{
        ...
        &:before{
          ...
          height: 1px;
          opacity: 0;
          background: ${props => props.theme.menuHoverColor ? props.theme.menuHoverColor : '#26f7b2'};
          transition: 450ms all;
        }
        &:hover{
          color: ${props => props.theme.menuHoverColor ? props.theme.menuHoverColor : '#26f7b2'};
          &:before{
            opacity: 1;
          }
        }
