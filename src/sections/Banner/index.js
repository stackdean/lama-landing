...
const Banner = () => {
    return (
        <BannerWrapper> 
            ...
            <img src={particleBottomRight} className="section__particle bottom-right" alt="Lama particles"/>
                <Container>
                    <Row>
                    ...
                    <img src={BannerImage} className="banner__thumb" alt="Lama banner thumb" />
                </Container>  
        </BannerWrapper>
    )
}
